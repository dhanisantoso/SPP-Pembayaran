...
if (isset($_POST['username'])) {
	...
	$query_siswa = mysqli_query($koneksi, "SELECT * FROM siswa WHERE nisn='$username' AND password='$password'");
    ...
    if (mysqli_num_rows($query) > 0) {
		...
		$_SESSION['user'] = mysqli_fetch_array($query_siswa);
		echo '<script>alert("Login Berhasil");location.href="index.php";</script>';
	}else{
									...
									<form method="post">
										<div class="mb-3">
											...
											<input class="form-control form-control-lg" type="text" name="username"
												placeholder="Masukkan Username/NISN anda" />
										</div>
										<div class="mb-3">
